...
def test_simple_figure():
    json_data = {
        ...
        "$$": [
            ...
            {
                "#name": "caption",
                "$$": [{"#name": "simple-para", "_": "This is a figure caption."}],
            },
            {
                "#name": "link",
                "$": {
...
def test_missing_text():
    json_data = {"#name": "para", "$": {"id": "p0010", "view": "all"}}
    expected_markdown = "\n\n"
    assert json_to_markdown(json_data) == expected_markdown
